...
SECRET_KEY = 'django-insecure-2ot(n55=0=y-uufu*ywm6yc1)dk#c1rn2)oac!yxe(re1smb&a'
...
EMAIL_HOST = 'sandbox.smtp.mailtrap.io'  # Use Mailtrap's SMTP host
EMAIL_PORT = 587  # Mailtrap's default port
EMAIL_USE_TLS = True
